<template>
  <div>
    ...
    <div v-if="index === 0" class="h-screen overflow-hidden">
      ...
      <img
        id="cv"
        class="mx-auto fade-in relative w-2/6 lg:w-1/4"
        alt="Curriculum Vitae"
        src="~/assets/curriculum-vitae.svg"
      >
      <img
        id="name"
        class="w-3/12 2xl:w-80 mx-auto mt-4 xl:mt-6 2xl:mt-8 fade-in relative"
        alt="Name"
        src="~/assets/name.svg"
      ...
      <img
        id="title"
        class="w-1/5 2xl:w-64 mx-auto mt-4 xl:mt-6 2xl:mt-8 fade-in z-10 relative"
        alt="Title"
              ...
              <div class="ml-6 md:ml-8 lg:ml-12 xl:ml-16 space-y-1 xl:space-y-3">
                ...
                <div>
                  <svg
                    ...
                    viewBox="0 0 48 48"
                    class="w-6 lg:w-7 xl:w-8 inline"
                  >
                    <path
