  ...
  <div>
    ...
    <div v-if="index === 0" class="h-screen overflow-hidden">
      <div id="mainFigureHanger" class="bounce-in-top z-30 relative">
        ...
        <img
          id="mainFigure"
          class="mx-auto z-30 relative w-80 xs:w-96 md:w-5/12 xl:w-4/12"
      ...
      <img
        id="cv"
        class="mx-auto fade-in relative w-60 xs:w-2/6 lg:w-1/4"
        alt="Curriculum Vitae"
        src="~/assets/curriculum-vitae.svg"
      >
      <img
        id="name"
        class="w-44 xs:w-3/12 2xl:w-80 mx-auto mt-4 xl:mt-6 2xl:mt-8 fade-in relative"
        alt="Name"
        src="~/assets/name.svg"
      ...
      <img
        id="title"
        class="w-32 xs:w-1/5 2xl:w-64 mx-auto mt-4 xl:mt-6 2xl:mt-8 fade-in z-10 relative"
        alt="Title"
        src="~/assets/title.svg"
        style="animation-duration: 3.9s;"
      >
      <h1 id="beginText" class="mt-4 lg:mt-6 xl:mt-8 2xl:mt-12 text-gray-400 text-xs sm:text-sm md:text-md lg:text-lg xl:text-2xl font-bold text-center constant-fade-in relative">
    ...
    <div v-if="index === 1" class="h-screen overflow-hidden">
      <Hanger
        ...
        class="bounce-in-top"
      />
      <div class="px-4 md:px-8 lg:px-14 xl:px-20 mx-auto mt-28 lg:mt-40 xl:mt-48 2xl:mt-60 max-w-7xl">
        <div id="agusCard" class="bg-gray-100 rounded-3xl flex flex-col p-4 lg:p-8 xl:p-12 space-y-2 md:space-y-4 xl:space-y-8 bounce-in-top">
          <div class="flex">
            ...
            <div class="flex flex-col justify-center text-gray-900">
              <div class="ml-3 xs:ml-4 sm:ml-6 md:ml-8 lg:ml-12 xl:ml-16 space-y-1 xl:space-y-3">
                ...
                <div>
                  <svg
                    ...
                    viewBox="0 0 48 48"
                    class="w-5 xs:w-6 lg:w-7 xl:w-8 inline"
                  >
                    <path
                  ...
                  <p class="inline xs:ml-2 text-sm md:text-md lg:text-xl align-bottom">
                    26/09/2000
                  </p>
                </div>
                <div>
                  ...
                  <p class="inline xs:ml-2 lg:ml-4 text-sm md:text-md lg:text-xl align-middle">
                ...
                <div>
                  ...
                  <p class="inline xs:ml-2 lg:ml-4 text-sm md:text-md lg:text-xl">
          ...
          <div class="text-sm md:text-md lg:text-xl">
            <p>
...
export default Vue.extend({
  ...
  beforeMount () {
    document.addEventListener('wheel', (e: WheelEvent) => {
      debounce(e.deltaY > 0 ? this.changeIndex(this.index + 1) : this.changeIndex(this.index - 1), 5000)
    })
  },
  destroyed () {
